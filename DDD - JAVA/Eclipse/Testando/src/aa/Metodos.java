...
public class Metodos {
	...
	public void escolheOpcao(int opcao) {
		if(opcao == 1 || opcao == 2 || opcao == 3 || opcao == 4) {
			...
			System.out.printf("O resultado da operação é: %.2f",calculaOpBasica(opcao, num1, num2));
		} else if(opcao == 5) {
			//Média ponderada
			...
			System.out.printf("A área do círculo é: %.2f", calculaAreaCirc(raio));
		} else if(opcao == 8) {
			//Área do retângulo
			...
			System.out.printf("A área do retângulo é: %.2f", calculaAreaRetangulo(base, altura));
		} else if(opcao == 9) {
			//Velocidade média
		    System.out.printf("Digite a distância em Km \n---> ");
		    double dist = input.nextDouble();
		    System.out.printf("Digite o tempo de duração da viagem em horas \n--->");
		    double tempo = input.nextDouble();
		    System.out.printf("A velocidade média da viagem é de %.2f Km/h.", calculaVelocidadeMedia(dist, tempo));
		} else if(opcao == 10) {
			//Soma todos os valores
			System.out.printf("Digite um número inteiro \n---> ");
		    int num = input.nextInt();
		    System.out.printf("A soma de todos os valores entre 1 e %d é %d. ", num, somaTodos(num)); 
		} else if(opcao == 11) {
			//Celsius para Fahrenheit
			System.out.printf("Digite um valor Celsius \n---> ");
			int celsius = input.nextInt();
			System.out.printf("A temperatura em Fahrenheit é: %.2f", converteCelsParaFah(celsius));
		} else if(opcao == 12) {
			//Fahrenheit para Celsius
			System.out.printf("Digite um valor Fahrenheit \n---> ");
			int fahr = input.nextInt();
			System.out.printf("A temperatura em Celsius é: %.2f", converteFahParaCels(fahr));
		} else if(opcao == 13) {
			//Raiz quadrada (Livre escolha)
			System.out.printf("Digite o número desejado \n---> ");
			double num = input.nextDouble();
			System.out.printf("A raiz quadrada de %.2f é %.2f", num, calculaRaizQuadrada(num));
		}
	...
	public void menu() {
		...
		System.out.println("# #      5 - MÉDIA PONDERADA                            # #");
		System.out.println("# #      6 - MÉDIA ARITIMÉTICA                          # #");
		System.out.println("# #      7 - ÁREA DO CÍRCULO                            # #");
		System.out.println("# #      8 - ÁREA DO RETÂNGULO                          # #");
		System.out.println("# #      9 - VELOCIDADE MÉDIA                           # #");
